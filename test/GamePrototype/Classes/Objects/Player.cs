...
namespace GamePrototype.Classes.Objects
{
    ...
    class Player : GameObject, Tools.IAnimated, Tools.IControlled
    {
        ...
        public Player(GraphicsDevice graphics, ContentManager content, Texture2D faceRight, List<Texture2D> walkRight, Texture2D faceUp, Texture2D faceDown, Rectangle bounds):base()
        {
